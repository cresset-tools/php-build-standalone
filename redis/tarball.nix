# Redis tarball derivation. Mirrors mariadb/tarball.nix for the `service`
# section: emits one self-contained tarball carrying redis-server,
...
# the PHP / MariaDB tarball layout. The service loop in shared/index.nix
